...
def site_settings(language_code: str = Depends(get_language_code), db: Session = Depends(get_db)) -> dict[str, Any]:
    return get_public_site_settings(db=db, language_code=language_code)
